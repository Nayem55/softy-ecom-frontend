...
export default function Home() {
  ...
  return <div className="softy-home">
    ...
    <section className="softy-hero">
      <img src={hero.image || softySettings.homeHero.image} alt="Softy skincare ritual" />
